  ...
  return (
    <Navbar className="navbar top" style={{ height: "70px", position: "fixed", width: "100%", top: "0", zIndex: "999", backgroundColor: "black" }}>
      <Nav>
        <MediaQuery maxWidth={950}>
          <Menu right className="cell2">
            <div className="burgerText">
              <NavLink className="burgerText" to="/" activeStyle={{ fontWeight: "bold", color: "ffae00" }}>
                Liquidity Pool
              </NavLink>
            </div>
            <div className="burgerText">
        ...
        >
          <ImgNextGen srcWebp={marginx_logo_white} height="50" alt="" />
        </div>
        ...
        <div>
          <ul className="topright rowC">
            <div className="rowC mr-4" style={{ textDecoration: "none" }}>
              <MediaQuery minWidth={951}>
                <div style={{ marginLeft: "10px", color: "grey" }}>
                  <NavLink className="textSmallBold1" activeClassName="gradient-text" to="/">
                    Liquidity Pool
                  </NavLink>
                </div>
                <div style={{ marginLeft: "30px" }}>
                  <div
                    className="textSmallBold1"
                    onClick={() => {
                      window.open(`https://forum.starscan.io/c/marginx/51`, "_blank");
                    }}
                  >
            ...
            {props.wallet || props.walletConnect ? (
              <Dropdown onMouseEnter={() => show2Dropdown(true)} onMouseLeave={() => show2Dropdown(false)} show={show2} autoClose="outside" style={{ padding: "0px" }}>
                <div style={{ margin: "0px", padding: "5px" }}>
                  <Dropdown.Toggle className="textWhiteLargeButton center cell2" variant="warning" size="sm" style={{ display: "flex", backgroundColor: "#1e1f23", border: "0px", padding: "5px 16px", width: "147.6px", height: "32px", borderRadius: "22px" }}>
                    <span className="cell2 dropdown" style={{ fontSize: "15px", marginRight: "5px" }}>
                      {props.first4Account}...{props.last4Account}
                    </span>
                    <span className="cell2 dropdown" style={{ fontSize: "6px" }}>
                      &#9660;
                    </span>
                  </Dropdown.Toggle>
                </div>
                ...
                trigger={open => (
                  <div style={{ margin: "0px", padding: "5px" }}>
                    <MediaQuery minWidth={401}>
                      <Buttons className="textWhiteLargeButton cell2 center" style={{ height: "32px", width: "100%", color: "black", border: "0px", padding: "5px 16px", backgroundImage: "linear-gradient(90deg, #18eed8 1%, #a6f616 100%)", borderRadius: "22px" }} size="lg">
                        Connect Wallet
                      </Buttons>
                    </MediaQuery>
              ...
              >
                {close => (
                  <div>
                    ...
                    <h4 className="center cell2 mb-2" style={{ color: "white", fontSize: "24px", padding: "5px 0px 20px" }}>
                      {" "}
                      Connect Wallet{" "}
                    </h4>
                    <div className="center" style={{ marginBottom: "15px" }}>
                      <div
                        className="verticalCenter cell2"
                        type="button"
                        style={{ backgroundColor: "#101314", borderRadius: "8px", height: "80px", width: "100%", minWidth: "150px", padding: "6px 25px" }}
                        onClick={async () => {
                          await props.connectMetamask(process.env.REACT_APP_chainid);
                        }}
                      >
                        <span className="mr-4">
                    ...
                    <div className="center" style={{ marginBottom: "15px" }}>
                      ...
                      >
                        <span className="mr-4">
                          <img src={coin98} width="23" height="23" alt="" />
                        </span>
                    ...
                    <div className="center mb-2">
                      <div
                        ...
                        style={{ backgroundColor: "#101314", borderRadius: "8px", height: "80px", width: "100%", minWidth: "150px", padding: "6px 25px" }}
                        onClick={async () => {
                          await props.mobileWalletConnect(process.env.REACT_APP_networkid);
                        }}
                      >
                        <span className="mr-4">
                          <img src={walletconnectlogo} width="23" height="23" alt="" />
                        </span>
      ...
      <Alert className="topRightAlert" style={{ backgroundColor: "#2A2C32", color: "white", border: "0px", borderRadius: "15px" }} show={alert} variant="dark">
        <Alert.Heading style={{ fontSize: "16px" }}>
          Copied
          <Buttons className="close cell2" style={{ background: "#1e1f23", color: "#fff", borderRadius: "12px", fontSize: "18px" }} onClick={() => setAlert(false)}>
            &#x2715;
          </Buttons>
        </Alert.Heading>

        <p style={{ fontSize: "12px" }}>You just copied {props.account}</p>
